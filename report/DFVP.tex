...
But let us assume, that we can construct function $|\Phi'\rangle$, that differs from $|\Phi\rangle$ by angular multiplier:
...
Let us consider for simplicity function $|\Psi\rangle$ of the family of functions $|\Phi'\rangle$. 
